...
function UpdateBlog() {
    ...
    const Validate = (e) => {
        ...
        axios.put("http://localhost:4000/api/Blogs/updateBlog", formData).then((res) => {
                ...
                <Form onSubmit={Validate} >
                    <Row className="mb-3">
                        <Form.Group as={Col} controlId="formGridProductID">
                            ...
                            <Form.Control type="text" placeholder="Enter the Blog ID" value={blogID} onChange={(e) => { setBlogID(e.target.value) }} />
                        </Form.Group>
                        <Form.Group as={Col} controlId="formGridProductID">
                    ...
                    <Form.Group as={Col} controlId="formGridProductID">
                        ...
                        <Form.Control type="text" placeholder="Enter Blogger Name" value={bloggerName} onChange={(e) => { setBloggerName(e.target.value) }} />
                    </Form.Group>

                    <Row className="mb-3">
                        <Form.Group as={Col} controlId="formGridPrice">
                            <Form.Label>Blogger position: </Form.Label>
                            <Form.Control as="textarea" rows={2} placeholder='Enter Blogger Position' value={bloggerPosition} onChange={(e) => { setBloggerPosition(e.target.value) }} />

                        </Form.Group>
                    </Row>
                    <Form.Group className="mb-3" controlId="formGridDescription">
                        <Form.Label>Blog content</Form.Label>
                        <Form.Control as="textarea" rows={10} placeholder='Enter Blog Content' value={content} onChange={(e) => { setContent(e.target.value) }} />
                    </Form.Group>
